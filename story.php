...
<body background=pic2.jpeg >
    <form>
        <div class='displayBlogs'>
            <table>
                <tr>
                    <td><label for='one'><h3>Story Number</label></td>
                    <td><input type='text' class='one' id='one' name='one'  style='background: pink'/></td>
                </tr>
                <tr>
                    <td><label for='two'  style='background: pink'><h3>Story Title</label></td>
                    <td><input type='text' class='two' id='two' name='two'  style='background: pink'/></td>
                </tr>
            </table>
            <textarea name='three' id='three' cols='150' rows='20'  style='background: #add8e6'></textarea>
        </div>
    </form>
...
if($u){
    ...
    echo "<h3>Total views for the page = ".$_SESSION['views'];
}
$users = array();
echo "<br>";
if($u){
    array_push($users, $user);
    echo "<h3>Number of users currently reading this story: ".count($users);
    echo "<br>";
